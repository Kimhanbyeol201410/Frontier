...
public sealed class MasterySmeltingCard : ShumitCard
{
    private const string EnchKey = "AdroitStacks";

    protected override IEnumerable<DynamicVar> CanonicalVars => new[] { new DynamicVar(EnchKey, 2m) };

    public MasterySmeltingCard()
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<PostCombatAdroitEnchantPower>(
            choiceContext,
            Owner.Creature,
